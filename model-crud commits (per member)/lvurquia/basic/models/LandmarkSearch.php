...
class LandmarkSearch extends Landmark
{
    ...
    {
        return [
            [['id', 'attendee_id'], 'integer'],
            [['landmark_name', 'landmark_address', 'landmark_distance_from_attendee'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'landmark_name', $this->landmark_name])
            ...
            ->andFilterWhere(['like', 'landmark_distance_from_attendee', $this->landmark_distance_from_attendee]);
